    ...
    <center>
        ...
        <div id="Cuadro">
            ...
            <form name="Login">
                ...
                <input type="txt" class="entrada" name="txtusu" id="txtusu">
                ...
                <input type="password" class="entrada" name="txtcont" id="txtcont">
                
                <br/><br/>
                
                <input type="button" value="Inicar Sesión" id="boton" onclick="validarAccesoAdministrador('<%=request.getContextPath()%>')">
